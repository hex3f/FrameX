...
namespace FrameX
{
    ...
    public static class Extension
    {
        ...
        public static void LocaSet(this Text text, string packName, string contentKey)
        {
        ...
        /// <param name="packName"></param>
        /// <param name="contentKey"></param>
        public static void LocaSet(this Image image, string packName, string contentKey)
        {
        ...
        /// <param name="packName"></param>
        /// <param name="contentKey"></param>
        public static void LocaSet(this AudioSource audioSource, string packName, string contentKey)
        {
        ...
        /// <param name="packName"></param>
        /// <param name="contentKey"></param>
        public static void LocaSet(this VideoPlayer videoPlayer, string packName, string contentKey)
        {
